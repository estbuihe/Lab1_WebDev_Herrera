...
import info
import pandas as pd #This is another library
...
about_me() #Do not forget to the run the function again for it to display
...
def education_section(education_data, course_data):
    ...
    st.write(f"**Degree:** {education_data['Degree']}") #if you want the text to be in B, put ** sorrounding the content
    st.write(f"**Graduation Date:** {education_data['Graduation Date']}")#Make sure you have a space after the ** to make thew word bold.
